        ...
        <View style={styles.content}>
          <View style={styles.promptContainer}>
            ...
            <View style={styles.promptBox}>
              <Text style={styles.promptExample}>A minimalist wolf wallpaper design</Text>
            </View>
          </View>

          <View style={styles.bottomContent}>
            <Text style={styles.title}>AI Wallpaper</Text>
            <Text style={styles.description}>
              Transform your wallpaper ideas into stunning designs. Describe your vision, select a style, and let Hexa create the perfect wallpaper design that tells your unique story!
            </Text>
